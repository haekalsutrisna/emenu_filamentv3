...
<div
      ...
      <div id="TopNav" class="relative flex flex-col px-5 mt-[20px] h-[170px]">
        <div class="relative flex items-center justify-between">
          ...
          >
            <img
              src="assets/images/icons/ic_bell.svg"
              class="w-[28px] h-[28px]"
              alt="icon"
            />
          </a>
        ...
        <h1 class="text-white font-[600] text-2xl leading-[30px] mt-[20px]">
        ...
        <div class="absolute bottom-0 left-0 right-0 w-full gap-2 px-5">
          ...
          >
            <img
              src="assets/images/icons/ic_search.svg"
      ...
      <div id="Categories" class="relative flex flex-col px-5 mt-[20px]">
        ...
        <div class="swiper w-full">
          ...
          <a href="#" class="swiper-slide !w-fit">
              <div
                class="flex flex-col items-center shrink-0 gap-2 text-center"
              >
                <div
                ...
                <div class="flex flex-col gap-[2px]">
                  <h3 class="font-light text-[#504D53] text-[14px]">
                    {{ $category->name }}
                  </h3>
                </div>
              </div>
              ...
              <a href="details.html" class="card">
                ...
                >
                  ...
                  >
                    ...
                    >
                      <img
                        src="assets/images/icons/ic_star.svg"
                        alt="rating"
                        class="w-4 h-4"
                      />
                  ...
                  <div class="flex flex-col gap-1">
                    <p class="text-[#F3AF00] font-[400] text-[12px]">{{$popular->productCategory->name}}</p>
      ...
      <div id="Recomendations" class="relative flex flex-col px-5 mt-[20px]">
        <div class="flex items-end justify-between">
          <h1 class="text-[#353535] font-[500] text-lg">
